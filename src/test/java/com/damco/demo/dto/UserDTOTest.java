...
class UserDTOTest {
	...
	public void init() {
		...
		underTest = new UserDTO(EXPECTED_USER_ID, EXPECTED_SUR_NAME, EXPECTED_FIRST_NAME, EXPECTED_TITLE, EXPECTED_DOB);
	}
	
	@Test
	void userParamTest() {
		
		assertEquals(EXPECTED_USER_ID,		underTest.getUserId());
